...
__device__ void _cupy_sosfilt(
	...
	T *s_out { s_buffer };
	T *s_zi {
		reinterpret_cast<T*>(&s_out[n_sections]) };
	T *s_sos {
		reinterpret_cast<T*>(
...
extern "C" __global__ void _cupy_sosfilt_float32(
	const int n_signals,
	const int n_samples,
	const int n_sections,
	const int zi_width,
...
extern "C" __global__ void _cupy_sosfilt_float64(
	const int n_signals,
	const int n_samples,
	const int n_sections,
	const int zi_width,
