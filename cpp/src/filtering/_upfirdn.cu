...
extern "C" __global__ void _cupy_upfirdn1D_float32( const float *__restrict__ inp,
...
extern "C" __global__ void _cupy_upfirdn1D_float64( const double *__restrict__ inp,
...
extern "C" __global__ void _cupy_upfirdn1D_complex64( const thrust::complex<float> *__restrict__ inp,
...
extern "C" __global__ void _cupy_upfirdn1D_complex128( const thrust::complex<double> *__restrict__ inp,
...
extern "C" __global__ void _cupy_upfirdn2D_float32( const float *__restrict__ inp,
                                                    const int inpH,
                                                    const float *__restrict__ h_trans_flip,
                                                    const int up,
                                                    const int down,
...
extern "C" __global__ void _cupy_upfirdn2D_complex64( const thrust::complex<float> *__restrict__ inp,
                                                      const int inpH,
                                                      const thrust::complex<float> *__restrict__ h_trans_flip,
                                                      const int up,
                                                      const int down,
...
extern "C" __global__ void _cupy_upfirdn2D_complex128( const thrust::complex<double> *__restrict__ inp,
                                                       const int inpH,
                                                       const thrust::complex<double> *__restrict__ h_trans_flip,
                                                       const int up,
                                                       const int down,
