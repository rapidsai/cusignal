...
If you need to run on an older compute capability such as Kepler (CC 3.X) or Maxwell (CC 5.X), you will need to build from source. Target architecture will be automatically detected at build time.
