...
class TestWindows:
    ...
    def test_general_cosine(self, num_samps):
        ...
        gpu_window = cusignal.windows.general_cosine(
            num_samps, HFT90D, sym=False
        )
    ...
    def test_boxcar(self, num_samps):
        ...
        gpu_window = cusignal.windows.boxcar(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_triang(self, num_samps):
        ...
        gpu_window = cusignal.windows.triang(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_bohman(self, num_samps):
        ...
        gpu_window = cusignal.windows.bohman(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_blackman(self, num_samps):
        ...
        gpu_window = cusignal.windows.blackman(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_nuttall(self, num_samps):
        ...
        gpu_window = cusignal.windows.nuttall(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_blackmanharris(self, num_samps):
        ...
        gpu_window = cusignal.windows.blackmanharris(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_flattop(self, num_samps):
        ...
        gpu_window = cusignal.windows.flattop(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_barlett(self, num_samps):
        ...
        gpu_window = cusignal.windows.bartlett(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_hann(self, num_samps):
        ...
        gpu_window = cusignal.windows.hann(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_tukey(self, num_samps, alpha):
        ...
        gpu_window = cusignal.windows.tukey(num_samps, alpha, sym=True)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_barthann(self, num_samps):
        ...
        gpu_window = cusignal.windows.barthann(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_general_hamming(self, num_samps, alpha):
        ...
        gpu_window = cusignal.windows.general_hamming(
    ...
    def test_hamming(self, num_samps):
        ...
        gpu_window = cusignal.windows.hamming(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_kaiser(self, num_samps, beta):
        ...
        gpu_window = cusignal.windows.kaiser(num_samps, beta, sym=True)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_gaussian(self, num_samps, std):
        ...
        gpu_window = cusignal.windows.gaussian(num_samps, std)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_general_gaussian(self, num_samps, p, std):
        ...
        gpu_window = cusignal.windows.general_gaussian(num_samps, p, std)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_chebwin(self, num_samps, at):
        ...
        gpu_window = cusignal.windows.chebwin(num_samps, at)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_cosine(self, num_samps):
        ...
        gpu_window = cusignal.windows.cosine(num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_exponential(self, num_samps, tau):
        ...
        gpu_window = cusignal.windows.exponential(num_samps, tau=tau)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
    ...
    def test_get_window(self, window, num_samps):
        ...
        gpu_window = cusignal.windows.get_window(window, num_samps)
        gpu_window = cp.asnumpy(gpu_window)
        assert array_equal(cpu_window, gpu_window)
